...
EchoApp follows the [Block Open Source Security Policy](https://github.com/block/.github/blob/main/SECURITY.md).
...
report it in this repository's `Security` tab -> `Report a vulnerability`.
...
This repository, as part of the [`block` GitHub organization](https://github.com/block).
